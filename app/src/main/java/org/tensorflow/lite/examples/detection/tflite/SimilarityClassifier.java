...
import org.tensorflow.lite.examples.detection.env.RectFDataObject;
...
public interface SimilarityClassifier {
  ...
  public class Recognition  implements Serializable {
    private static final long serialVersionUID = 8736847634070552222L;
    /**
    ...
    /** Display name for the recognition. Unique.
     * If multiple instance for the same face exist the the format is
     * 'name_instance'
     * .*/
    ...
    private RectFDataObject location;
    private Integer color;
    private BitmapDataObject crop;
    ...
    public Recognition(
      ...
      this.location = new RectFDataObject(location);
      this.color = null;
      this.extra = null;
      this.crop = null;
    }
    ...
    public RectF getLocation() {
      return new RectF(location.getcurrentRectF());
    }
    ...
    public void setCrop(Bitmap crop) {
      this.crop = new BitmapDataObject(crop);
    }

    public Bitmap getCrop() {
      return this.crop.getCurrentImage();
    }
  }
}
