...
public abstract class CameraActivity extends AppCompatActivity
    ...
    public static final String CAMERA_ACTIVITY_BROADCAST_MESSAGE_FINNISH_CAMERA = "finnish_camera_activity";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        // the camera activity can be controlled by other activities that started it
        ...
        BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context arg0, Intent intent) {
                ...
                if (action.equals(CAMERA_ACTIVITY_BROADCAST_MESSAGE_FINNISH_CAMERA)) {
                    finish();
                    // DO WHATEVER ELSE YOU WANT.
                }
            }
        };
        registerReceiver(broadcastReceiver, new IntentFilter(CAMERA_ACTIVITY_BROADCAST_MESSAGE_FINNISH_CAMERA));
    ...
    public synchronized void onDestroy() {
        ...
        super.onDestroy();
        if (SpeechHandler.getSingleObject() == null) {
